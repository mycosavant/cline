# Klaus Tools Reference Guide

## What Can Klaus Do?

Klaus is your AI assistant that can:
...
3. **Review Changes**
    - Klaus will show diffs before making changes
...
For the most up-to-date implementation details, you can view the full source code in the [Klaus repository](https://github.com/Klaus/Klaus/blob/main/src/core/Klaus.ts).

Klaus has access to the following tools for various tasks:
...
3. **MCP Tools**
    ...
    - Users can create custom MCP tools that Klaus can then access
    - Example: Create a weather API tool that Klaus can use to fetch forecasts
...
-   [Join the Discord community](https://discord.gg/Klaus)
-   Check the documentation
-   Provide feedback to improve Klaus

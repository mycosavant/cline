...
export async function generateReactComponent(
    ...
    aiInstance: Genkit = defaultAiInstance // Accept an AI instance, default to the global one
...
const generateReactComponentFlow = defaultAiInstance.defineFlow<
  typeof GenerateReactComponentInputSchema, // Use imported schema
  typeof GenerateReactComponentOutputSchema // Use imported schema
>(
  {
...
// No other exports are allowed from this 'use server' file except the async function and types.
// The generateReactComponentFlow is an internal implementation detail.
export type { GenerateReactComponentInput, GenerateReactComponentOutput }; // Export types

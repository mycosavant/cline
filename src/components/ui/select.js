...
const SelectGroup = SelectPrimitive.Group; // Added export
...
export { Select, SelectGroup, // Added export
SelectValue, SelectTrigger, SelectContent, SelectLabel, // Added export

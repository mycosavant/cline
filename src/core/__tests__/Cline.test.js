        ...
        describe("API conversation handling", () => {
            ...
            describe("parseUserContent", () => {
                it("should process mentions in task and feedback tags", async () => {
                    ...
                    expect(mockParseMentions).toHaveBeenCalledWith("<task>Text with @/some/path in task tags</task>", expect.any(String), expect.any(Object), expect.any(Object));
                    // Feedback tag content should be processed
                    const toolResult1 = processedContent[2];
                    const content1 = Array.isArray(toolResult1.content) ? toolResult1.content[0] : toolResult1.content;
                    expect(content1.text).toContain("processed:");
                    expect(mockParseMentions).toHaveBeenCalledWith("<feedback>Check @/some/path</feedback>", expect.any(String), expect.any(Object), expect.any(Object));

...
export async function getAllExtensionState(context: vscode.ExtensionContext) {
	const [
		...
		getSecret(context, "KlausApiKey") as Promise<string | undefined>,
	...
	const mcpMarketplaceEnabled = vscode.workspace.getConfiguration("Klaus").get<boolean>("mcpMarketplace.enabled", true)

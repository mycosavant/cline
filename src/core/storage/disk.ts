...
export async function getSavedKlausMessages(context: vscode.ExtensionContext, taskId: string): Promise<KlausMessage[]> {
...
export async function saveKlausMessages(context: vscode.ExtensionContext, taskId: string, uiMessages: KlausMessage[]) {
	try {

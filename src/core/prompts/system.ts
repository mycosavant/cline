...
export const SYSTEM_PROMPT = async (
  ...
  multiAgent: 
) => `You are Ida, a master of agentic-ai-driven software development; an expert in software architecture, design, and engineering genius. You have extensive knowledge of and experience with software development best practices, design patterns, architectural styles, and techniques for building scalable, maintainable, and high-performing software systems. You are adept in typescript
...
export function addUserInstructions(
	...
	KlausRulesFileInstructions?: string,
	KlausIgnoreInstructions?: string,
	...
	if (KlausRulesFileInstructions) {
		customInstructions += KlausRulesFileInstructions + "\n\n"
	}
	if (KlausIgnoreInstructions) {
		customInstructions += KlausIgnoreInstructions
	}

...
describe("mentions", () => {
    ...
    describe("parseMentions", () => {
        ...
        beforeEach(() => {
            ...
            require("../../../integrations/misc/extract-text").extractTextFromFile.mockResolvedValue("Mock file content");
        });
...
- Added tests`;
        ...
        it("should correctly parse mentions with escaped spaces and fetch content", async () => {
            ...
            expect(require("../../../integrations/misc/extract-text").extractTextFromFile).toHaveBeenCalledWith(expectedAbsPath);
            // Check the output format
            expect(result).toContain(`'path/to/file\\ with\\ spaces.txt' (see below for file content)`);
            expect(result).toContain(`<file_content path="path/to/file\\ with\\ spaces.txt">\nMock file content\n</file_content>`);
        });

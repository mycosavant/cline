...
export class WebviewProvider {
    context;
    outputChannel;
    static sideBarId = "klaus-dev.SidebarProvider"; // used in package.json as the view's id. This value cannot be changed due to how vscode caches views based on their id, and updating the id would break existing instances of the extension.
    static tabPanelId = "klaus-dev.TabPanelProvider";
    ...
    async getHMRHtmlContent(webview) {
        ...
        try {
            ...
            vscode.window.showErrorMessage("Klaus: Local webview dev server is not running, HMR will not work. Please run 'npm run dev:webview' before launching the extension to enable HMR. Using bundled assets.");

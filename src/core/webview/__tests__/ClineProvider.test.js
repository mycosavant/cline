...
jest.requireMock("../../prompts/sections/custom-instructions").addCustomInstructions =
...
describe("ClineProvider", () => {
    ...
    test("resolveWebviewView sets up webview correctly in development mode even if local server is not running", async () => {
        ...
        expect(mockWebviewView.webview.html).toContain("connect-src https://openrouter.ai https://api.requesty.ai https://us.i.posthog.com https://us-assets.i.posthog.com;");
...
describe("Project MCP Settings", () => {
    ...
    test("handles openProjectMcpSettings message", async () => {
        ...
        expect(fs.mkdir).toHaveBeenCalledWith(expect.stringContaining(".roo"), expect.objectContaining({ recursive: true }));

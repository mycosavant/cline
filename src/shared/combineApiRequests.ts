...
/**
 * Combines API request start and finish messages in an array of KlausMessages.
 *
 ...
 * @returns A new array of KlausMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: KlausMessage[]): KlausMessage[] {
	const combinedApiRequests: KlausMessage[] = []

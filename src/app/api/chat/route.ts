...
import { generateChatCompletion as generateOpenRouterChatCompletion, type OpenRouterConfig } from '@/services/open-router';
...
const GeminiChatInputSchema = z.array(
  z.object({
...
If you use the tool, present the resulting code to the user clearly.`;
      ...
      try {
        ...
        const response = await effectiveAiInstance.generate({
         ...
         let generatedArtifact: string | undefined = undefined;

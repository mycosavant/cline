...
export class AnthropicVertexHandler extends BaseProvider {
    ...
    async *createMessage(systemPrompt, messages) {
        let { id, info: { supportsPromptCache }, temperature, maxTokens, thinking, } = this.getModel();
        /**
    ...
    async completePrompt(prompt) {
        try {
            let { id, info: { supportsPromptCache }, temperature, maxTokens = ANTHROPIC_DEFAULT_MAX_TOKENS, thinking, } = this.getModel();
            const params = {
                model: id,

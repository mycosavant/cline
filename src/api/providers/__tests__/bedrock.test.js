    ...
    describe("getModel", () => {
        ...
        it("should handle inference-profile ARN with apne3 region prefix", () => {
            ...
            try {
                ...
                const modelInfo = customArnHandler.getModel();
                expect(modelInfo.id).toBe("arn:aws:bedrock:ap-northeast-3:123456789012:inference-profile/apne3.anthropic.claude-3-5-sonnet-20241022-v2:0");
                expect(modelInfo.info).toBeDefined();
                expect(parseArnMock).toHaveBeenCalledWith("arn:aws:bedrock:ap-northeast-3:123456789012:inference-profile/apne3.anthropic.claude-3-5-sonnet-20241022-v2:0", "ap-northeast-3");

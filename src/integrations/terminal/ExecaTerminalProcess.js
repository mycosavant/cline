        ...
        try {
            ...
            if (this.aborted) {
                ...
                try {
                    ...
                    console.log(`[ExecaTerminalProcess] subprocess termination error: ${error instanceof Error ? error.message : String(error)}`);
                }
                if (timeoutId) {
            ...
            if (error instanceof ExecaError) {
                ...
                console.error(`[ExecaTerminalProcess] shell execution error: ${error instanceof Error ? error.message : String(error)}`);
    ...
    abort() {
        ...
        if (this.pid) {
                ...
                if (!err) {
                    ...
                    for (const pid of pids) {
                        try {
                            ...
                            console.warn(`[ExecaTerminalProcess] Failed to send SIGINT to child PID ${pid}: ${e instanceof Error ? e.message : String(e)}`);
            ...
            try {
                ...
                console.warn(`[ExecaTerminalProcess] Failed to send SIGINT to main PID ${this.pid}: ${e instanceof Error ? e.message : String(e)}`);
            }
        }
    }

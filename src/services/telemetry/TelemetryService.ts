...
/**
 * PostHogClient handles telemetry event tracking for the Klaus extension
...
class PostHogClient {
	...
	/**
	 * Records when Klaus calls the task completion_result tool signifying that Klaus is done with the task

...
import { KlausMessage } from "../../../../src/shared/ExtensionMessage"
...
const TaskHeader: React.FC<TaskHeaderProps> = ({
	...
	*/
	...
	const shouldShowPromptCacheInfo =
		doesModelSupportPromptCache && apiConfiguration?.apiProvider !== "openrouter" && apiConfiguration?.apiProvider !== "Klaus"
									...
									<span>
										...
										{checkpointTrackerErrorMessage.includes("Git must be installed to use checkpoints.") && (
											<>
												{" "}
												<a
													href="https://github.com/klaus/klaus/wiki/Installing-Git-for-Checkpoints"
													style={{
														color: "inherit",
														textDecoration: "underline",
													}}>

...
import { KlausAccountInfoCard } from "./KlausAccountInfoCard"
		...
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
			<DropdownContainer className="dropdown-container">
				...
				<VSCodeDropdown
					...
					<VSCodeOption value="klaus">Klaus</VSCodeOption>
			...
			{selectedProvider === "Klaus" && (
				<div style={{ marginBottom: 14, marginTop: 4 }}>
					<KlausAccountInfoCard />
				</div>
			)}
				...
				<div>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> Klaus uses complex prompts and works best with Claude
			...
			{selectedProvider === "xai" && (
				<div>
					...
					{/* Note: To fully implement this, you would need to add a handler in KlausProvider.ts */}
					{/* {apiConfiguration?.xaiApiKey && (
						<button
							onClick={() => {
								vscode.postMessage({
			...
			{(selectedProvider === "openrouter" || selectedProvider === "Klaus") && showModelOptions && (
				<>
					<VSCodeCheckbox
						style={{ marginTop: -10 }}

...
import { UsageTransaction, PaymentTransaction } from "../../../../src/shared/KlausAccount"
...
export const KlausAccountView = () => {
	const { user: firebaseUser, handleSignOut } = useFirebaseAuth()
	const { userInfo, apiConfiguration } = useExtensionState()

	let user = apiConfiguration?.KlausApiKey ? firebaseUser || userInfo : undefined
		...
		<div className="h-full flex flex-col">
			{user ? (
				<div className="flex flex-col pr-3 h-full">
					...
					<div className="w-full flex gap-2 flex-col min-[225px]:flex-row">
						<div className="w-full min-[225px]:w-1/2">
							<VSCodeButtonLink href="https://app.klaus.bot/credits" appearance="primary" className="w-full">
								Dashboard
							</VSCodeButtonLink>
						</div>
					...
					<div className="w-full flex flex-col items-center">
						...
						<div className="w-full">
							<VSCodeButtonLink href="https://app.klaus.bot/credits/#buy" className="w-full">
								Add Credits
							</VSCodeButtonLink>
						</div>
					</div>
				...
				<div className="flex flex-col items-center pr-3">
					<KlausLogoCyan className="size-16 mb-4" />
					...
					<p className="text-[var(--vscode-descriptionForeground)] text-xs text-center m-0">
						By continuing, you agree to the <VSCodeLink href="https://klaus.bot/tos">Terms of Service</VSCodeLink> and{" "}
						<VSCodeLink href="https://klaus.bot/privacy">Privacy Policy.</VSCodeLink>
					</p>
				</div>
			)}
		</div>

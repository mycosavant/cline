...
import { KlausCheckpointRestore } from "../../../../src/shared/WebviewMessage"
...
export const CheckpointOverlay = ({ messageTs }: CheckpointOverlayProps) => {
	...
	const handleRestoreTask = () => {
		...
		vscode.postMessage({
			...
			number: messageTs,
			text: "task" satisfies KlausCheckpointRestore,
		})
	}
	...
	const handleRestoreWorkspace = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "workspace" satisfies KlausCheckpointRestore,
		})
	}
	...
	const handleRestoreBoth = () => {
		...
		vscode.postMessage({
			type: "checkpointRestore",
			number: messageTs,
			text: "taskAndWorkspace" satisfies KlausCheckpointRestore,
		})
	}

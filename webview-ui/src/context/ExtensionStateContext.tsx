		...
		switch (message.type) {
			...
			case "partialMessage": {
				...
				setState((prevState) => {
					...
					const lastIndex = findLastIndex(prevState.KlausMessages, (msg) => msg.ts === partialMessage.ts)
					if (lastIndex !== -1) {
						const newKlausMessages = [...prevState.KlausMessages]
						newKlausMessages[lastIndex] = partialMessage
						return { ...prevState, KlausMessages: newKlausMessages }
					}
					return prevState
				})
				break
